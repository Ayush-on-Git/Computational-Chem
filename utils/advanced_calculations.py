...
def calculate_load_bearing_capacity(traffic_load: str, material_properties: Dict[str, Any]) -> float:
    ...
    load_multiplier = load_factors.get(traffic_load, 0.6)
...
def calculate_environmental_impact(material_properties: Dict[str, Any], is_recycled: bool) -> float:
    ...
    base_score = 7.0  # Default environmental score
    ...
    maintenance_impact = (10 - material_properties['properties']['maintenance']) * 0.1
...
def calculate_weather_resistance(weather: str, material_properties: Dict[str, Any]) -> float:
    ...
    weather_factors = {
        'hot': {'durability_weight': 0.3, 'weather_resistance_weight': 0.7},
...
def calculate_maintenance_prediction(
    ...
    # Traffic load impact
    traffic_factors = {'low': 0.6, 'medium': 0.8, 'high': 1.0, 'very high': 1.2}
    traffic_impact = traffic_factors.get(traffic_load, 0.8)
